...
def main():
    ...
    menu_data = [
        ...
        # {'id':'Copy','icon':"far fa-chart-bar",,'label':"Copy"},
        {'icon': "fas fa-tachometer-alt", 'label':"Performance",'ttip':"I'm the Dashboard tooltip!"}, #can add a tooltip message
        ...
        {'icon': "🐙", 'label':"Documents"},#no tooltip message
